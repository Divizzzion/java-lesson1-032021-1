...
public abstract class Animal extends Object {
    ...
    public void run(float runLength) {
        if (runLength <= runLimit) {
            ...
            System.out.println(this.name + " не может пробежать расстояние: " + runLength + " метров. Его лимит: " + this.runLimit + " метров!");
    }
    ...
    public void swim(float swimLength) {
        if (swimLength <= swimLimit) {
            ...
            System.out.println(this.name + " не может проплыть расстояние: " + swimLength + " метров. Его лимит: " + this.swimLimit + " метров!");
    }
    ...
    public void jump(float jumpHeight) {
        if (jumpHeight <= jumpLimit) {
            ...
            System.out.println(this.name + " не может перепрыгнуть высоту: " + jumpHeight + " метров. Его лимит: " + this.jumpLimit + " метров!");
    }
